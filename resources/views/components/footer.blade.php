    ...
    <div class="container px-4 mx-auto">
      <div class="flex flex-wrap mb-12 lg:mb-20 -mx-3 text-center lg:text-left">
        ...
        <div class="w-full lg:w-2/5 px-3 mb-8 lg:mb-0">
          <p class="max-w-md mx-auto lg:max-w-full lg:mx-0 lg:pr-32 lg:text-lg text-blueGray-400 leading-relaxed">Software Engineer wants to learn more about technology.</p>
        </div>
        <div class="w-full lg:w-1/5 px-3 mb-8 lg:mb-0">
          ...
          <p class="lg:text-lg text-blueGray-400">Alex Miyami:Skander Street</p>
        </div>
        <div class="w-full lg:w-1/5 px-3">
          <p class="mb-2 lg:mb-4 lg:text-lg font-bold font-heading text-blueGray-800">Contact</p>
          <p class="lg:text-lg text-blueGray-400">nagyahmed688@gmail.com</p>
        </div>
      </div>
